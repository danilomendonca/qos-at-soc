...
\hline
((``web service'' OR ``web services'' OR ``service oriented'' OR SOA OR SaaS OR PaaS OR ``service orientation'' OR SOC) AND (``quality of services'' OR ``quality of service'' OR QOS)) \\
\hline
\end{tabular}
\end{table}
