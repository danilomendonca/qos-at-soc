...
pesquisa. As principais constru\c{c}\~{o}es do nosso estudo est\~{a}o em definir os conceitos de ``QoS em SOC'', definir o per\'{i}odo de publica\c{c}\~{o}es significativa para o estudo e o mapeamento sistemático em si. 
